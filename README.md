...
* **Presentation Layer (`interface.h/cpp`):** Exclusively manages user interaction, rendering visual components, and capturing events (keyboard/mouse) using the FTXUI framework.
...
<p align="center">
  ![structure](https://github.com/user-attachments/assets/6b72be95-9d85-434d-809d-060e16fb64d5)
</p>
...
<p align="center">
  ![unic](https://github.com/user-attachments/assets/2bf3f8ee-bee9-4765-864f-338e355442c5)
</p>
...
## 4. User Interface ([FTXUI - Functional Terminal User Interface](https://arthursonzogni.github.io/FTXUI/))
The interface was developed using a declarative model similar to the DOM used in web development, allowing for a reactive experience within the terminal.
...
<p align="center">
  ![add](https://github.com/user-attachments/assets/6b9509cd-89fb-4d23-89a8-2801eb00ebd6)
</p>
...
<p align="center">
  ![search](https://github.com/user-attachments/assets/dc38b619-9cf2-4ddf-844c-2579830ee967)
</p>
...
<p align="center">
  ![delete](https://github.com/user-attachments/assets/f960666f-11f4-4ca8-95ff-faa53bc9e916)
</p>
